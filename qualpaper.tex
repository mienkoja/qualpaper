...
\begin{frontmatter}
  ...
  \title{Constrained Parenting Decisions:\\ Test Toward a General Model of Child Maltreatment\tnoteref{mytitlenote}}
...
{\centering \includegraphics[width=\maxwidth]{figure/Figure1} 
...
{\centering \includegraphics[width=\maxwidth]{figure/Figure2} 
...
{\centering \includegraphics[width=\maxwidth]{figure/ModelResultGph2} 

}

\caption[$P(\text{All } D_{II})$ as a function of $A$]{$P(\text{All } D_{II})$ as a function of $A$\label{modModelResultGph2}}
\end{figure}
